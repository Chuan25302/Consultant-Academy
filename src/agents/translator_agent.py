...
4. **เก็บคำ qualifier ของต้นฉบับ** เช่น "ประมาณ", "โดยทั่วไป", "ในกรณีศึกษาที่พบบ่อย", range ของตัวเลข — ห้ามแต่งให้แม่นยำขึ้น
5. ถ้าต้นฉบับมี "โรงงานขนาด X แห่งหนึ่ง" → ห้ามเปลี่ยนเป็นชื่อบริษัทเฉพาะ
6. จบด้วย Consultant Move ที่ใช้กับลูกค้าได้ทันที
7. ไม่เกิน 500 คำ
8. บรรทัดสุดท้ายเป็น glossary:
